...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Data Siswa | CRUD</a>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2" id="about">
                ...
                <p>Website ini merupakan website resmi pendataan siswa SMK NEGERI 1 SUMBAWA</p>
            </div>
            <div class="col-md-6 my-2 text-center link">
                <h4 class="fw-bold text-uppercase">Account Links</h4>
                <a href="https://web.facebook.com/fiqar.rama/" target="_blank"><i class="bi bi-facebook fs-3"></i></a>
                <a href="https://github.com/fiqar2001" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/fiqarrmdhn/" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href="https://twitter.com/fiqar28" target="_blank"><i class="bi bi-twitter fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created by <u style="color: #fff;">Muhammad Fiqar Ramadhan</u></p>
    </footer>
    <!-- Close Footer -->
